...
public class HexBinary implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = hexBinary
	 * Namespace URI = http://www.w3.org/2005/05/xmlmime Namespace Prefix = ns1
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "hexBinary", xmlWriter);
			}
	...
	public static class Factory {
		...
		public static HexBinary fromString(java.lang.String value, java.lang.String namespaceURI) {
			HexBinary returnValue = new HexBinary();

			returnValue.setHexBinary(org.apache.axis2.databinding.utils.ConverterUtil.convertToHexBinary(value));

			return returnValue;
		}

		public static HexBinary fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content) {
					...
					if (fullTypeName != null) {
						...
						if (!"hexBinary".equals(type)) {
							...
							return (HexBinary) null /*
							                         * com.csf.documentgeneratorservice.ExtensionMapper.getTypeObject(
							                         * nsUri,type,reader)
							                         */;
						}
						...
						if (reader.isStartElement() || reader.hasText()) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								throw new org.apache.axis2.databinding.ADBException(
								        "The element: " + "hexBinary" + "  cannot be null");
							}
